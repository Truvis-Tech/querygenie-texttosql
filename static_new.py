...
def main():
    """Generate comprehensive static.json with all metadata including performance parameters"""
    print("🚀 Starting enhanced metadata extraction with performance parameters...")
    ...
    print(f"📊 Extracting from: {project_id}.{dataset_id}")
